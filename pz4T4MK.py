...
def veroyatn_gen(k,n):
    ...
    while 1 == 1:
        ...
        for i in range(7):
            ...
            # Проверка тестов Фeрма и Соловея-Штрассена
...
def gen_komb(k):
    ...
    psevd = veroyatn_gen(k//t,z) # Генерация псевдослучайных чисел
...
while 1==1:
    print('#################################################################################')
    print('## 1 - генерация псевдослучайного числа вероятностным методом введите # #########')
    print('## 2 - генерация псевдослучайного числа комбинированным методом  ################')
    print('## 3 - генерация псевдослучайного числа с изветным разложением функции Эйлера####')
    print('## 4 - генерация псевдослучайного числа по ГОСТ Р 34.10-94  #####################')
    print('#################################################################################')
    h = int(input())
    if h == 1:
        ...
        k = int(input())
        n = 2
        print('p = ', veroyatn_gen(k,n)[0])
        print('q = ', veroyatn_gen(k,n)[1])
        print('\n')
    elif h == 2:
        print('Введите порядок k бит')
        k = int(input())
